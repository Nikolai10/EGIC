...
gen_merge_semantic_and_instance_maps_op = load_library.load_op_library(resource_loader.get_path_to_datafile('/tf/notebooks/icmla-refactored-coco/deeplab2/tensorflow_ops/kernels/merge_semantic_and_instance_maps_op.so'))#load_library.load_op_library(resource_loader.get_path_to_datafile('../../kernels/merge_semantic_and_instance_maps_op.so'))
